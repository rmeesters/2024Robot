...
public class PneumaticsHandler {
    ...
    private final Solenoid s_tiltSolenoid = new Solenoid(PneumaticsModuleType.REVPH, 14);
    private final Solenoid s_ampSolenoid = new Solenoid(PneumaticsModuleType.REVPH, 13);
    ...
    public void setTrapSolenoid(boolean value) {
