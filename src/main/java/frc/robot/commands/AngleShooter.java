...
public class AngleShooter extends Command {
    ...
    // @Override
    // public void execute() {
    //     if (targetShaftPosition < s_Shooter.armPosition)
    //         s_Shooter.setAngleAdjustmentSpeed(speed, false);
    //     else
    //         s_Shooter.setAngleAdjustmentSpeed(-speed, false);
    ...
    //     s_Shooter.armPosition = targetShaftPosition;
    //     timer.stop();
    ...
    //     return timer.hasElapsed(Math.abs(targetShaftPosition - s_Shooter.armPosition) / speed);
    // }
}
