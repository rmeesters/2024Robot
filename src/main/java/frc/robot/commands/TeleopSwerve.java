...
public class TeleopSwerve extends Command {    
    ...
    public TeleopSwerve(Swerve s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, DoubleSupplier rotationTargetSup, BooleanSupplier robotCentricSup) {
