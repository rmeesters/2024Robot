...
public class SwerveCommand extends Command {    
    ...
    public SwerveCommand(Swerve s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, DoubleSupplier rotationTargetSup, BooleanSupplier robotCentricSup) {
